...
object Det3 {
  ...
  val obj_DerDet3x1 = ring("-2*p23*(p23-p12-p13)")
  val obj_DerDet3x2 = ring("-2*p13*(p13-p12-p23)")
  val obj_DerDet3x3 = ring("-2*p12*(p12-p13-p23)")
  val obj_DerDet3x11 = ring("-4*p23")
  val obj_DerDet3x12 = ring("-2*(p12-p23-p13)")
  val obj_DerDet3x13 = ring("-2*(p13-p12-p23)")
  val obj_DerDet3x21 = ring("-2*(p12-p23-p13)")
  val obj_DerDet3x22 = ring("-4*p13")
  val obj_DerDet3x23 = ring("-2*(p23-p12-p13)")
  val obj_DerDet3x31 = ring("-2*(p13-p12-p23)")
  val obj_DerDet3x32 = ring("-2*(p23-p12-p13)")
  val obj_DerDet3x33 = ring("-4*p12")
  val obj_DerDet3x0 = ring("-2*p12*p13*p23")
  val obj_ge2 = ring("-4*p13*p23+2*p13^2-4*p12*p13+2*p23^2-4*p23*p12+2*p12^2")
  val obj_all = Seq(obj_DerDet3x1, obj_DerDet3x2, obj_DerDet3x3, obj_DerDet3x11, obj_DerDet3x12, obj_DerDet3x13, obj_DerDet3x21, obj_DerDet3x22, obj_DerDet3x23, obj_DerDet3x31, obj_DerDet3x32, obj_DerDet3x33, obj_DerDet3x0, obj_ge2)
