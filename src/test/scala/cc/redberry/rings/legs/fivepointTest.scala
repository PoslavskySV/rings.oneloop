...
import cc.redberry.rings.sym.fivepoint
...
class fivepointTest {
  ...
  def test1(): Unit = {
    ...
    implicit val ring: Frac[MultivariatePolynomial[BigInteger]] = fivepoint.ring

    val (p12, p23, p34, p45, p15) = ring("p12", "p23", "p34", "p45", "p15")
    val (p13, p14, p24, p25, p35) = ring("p13", "p14", "p24", "p25", "p35")
    val d = ring("d")

    val expr = fivepoint.I5msls(2, 2, 1, 1, 1, d + 2, p12, p23, p34, p45, p15, p13, p14, p24, p25, p35)
